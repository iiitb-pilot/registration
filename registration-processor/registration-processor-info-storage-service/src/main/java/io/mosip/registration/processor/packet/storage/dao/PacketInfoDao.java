...
public class PacketInfoDao {
	 ...
	 */
	private List<IndividualDemographicDedupeEntity> getAllDemographicEntities(String name, String gender, String nrcId, String dob,
			String langCode) {
	...
	public List<DemographicInfoDto> getAllDemographicInfoDtos(String name, String gender, String dob,String nrcId, String langCode) {
		...
		List<IndividualDemographicDedupeEntity> demographicInfoEntities = getAllDemographicEntities(name, gender, dob, nrcId, langCode);
