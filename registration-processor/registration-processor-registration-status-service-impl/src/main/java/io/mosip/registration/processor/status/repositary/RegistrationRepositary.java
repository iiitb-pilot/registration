...
public interface RegistrationRepositary<T extends BaseRegistrationEntity, E> extends BaseRepository<T, E> {
	...
	public List<RegistrationStatusEntity> getResumablePackets(@Param("statusCode") String statusCode, @Param("timeDifference") LocalDateTime timeDifference, @Param("fetchSize") Integer fetchSize, @Param("excludeStageNames") List<String> excludeStageNames);
