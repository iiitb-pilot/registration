	...
	public Object getApi(ApiName apiName, List<String> pathsegments, String queryParamName, String queryParamValue,
		...
		if (apiHostIpPort != null) {
			...
			try {
				...
				regProcLogger.info("SESSION_ID", "GET API Call", "RESPONSE", "Get API for  - " + uriComponents.toUri().toString() + " Time taken to complete " + TimeUnit.SECONDS.convert(timeDifference, TimeUnit.NANOSECONDS));
	...
	public Object postApi(ApiName apiName, String queryParamName, String queryParamValue, Object requestedData,
		...
		if (builder != null) {
			...
			try {
				...
				Long timeDifference = System.nanoTime()-startTime;
				regProcLogger.info("SESSION_ID", "GET API Call", "RESPONSE", "POST API for  - " + builder.toUriString() + " Time taken to complete " + TimeUnit.SECONDS.convert(timeDifference, TimeUnit.NANOSECONDS));
	...
	public Object patchApi(ApiName apiName, List<String> pathsegments, String queryParamName, String queryParamValue,
		...
		if (builder != null) {
			...
			try {
				...
				Long timeDifference = System.nanoTime()-startTime;
				regProcLogger.info("SESSION_ID", "GET API Call", "RESPONSE", "PATCH API for  - " + builder.toUriString() + " Time taken to complete " + TimeUnit.SECONDS.convert(timeDifference, TimeUnit.NANOSECONDS));
	...
	public Object putApi(ApiName apiName, List<String> pathsegments, String queryParamName, String queryParamValue,
		...
		if (builder != null) {
			...
			try {
				...
				Long timeDifference = System.nanoTime()-startTime;
				regProcLogger.info("SESSION_ID", "GET API Call", "RESPONSE", "PUT API for  - " + builder.toUriString() + " Time taken to complete " + TimeUnit.SECONDS.convert(timeDifference, TimeUnit.NANOSECONDS));
	...
	public Integer headApi(ApiName apiName, List<String> pathsegments, List<String> queryParamName, List<Object> queryParamValue) throws ApisResourceAccessException {
		...
		if (apiHostIpPort != null) {
			...
			try {
				...
				Long timeDifference = System.nanoTime()-startTime;
				regProcLogger.info("SESSION_ID", "GET API Call", "RESPONSE", "HEAD API for  - " + builder.toUriString() + " Time taken to complete " + TimeUnit.SECONDS.convert(timeDifference, TimeUnit.NANOSECONDS));
